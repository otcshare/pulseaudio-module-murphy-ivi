...
static pa_bool_t find_default_route(struct userdata *, mir_node *,
                                    am_connect_data *);
                                   ...
                                   mir_node        *to)
{
    ...
    if (from->index == PA_IDXSET_INVALID || to->index == PA_IDXSET_INVALID) {
        pa_log_debug("ignoring default route %s => %s: invalid audiomgr ID",
...
static pa_bool_t find_default_route(struct userdata *u,
                                    mir_node        *node,
                                    am_connect_data *cd)
{
    pa_audiomgr *am;
